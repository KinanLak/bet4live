    ...
    def unsubscribe(self, channel='default channel', properties=None):
        ...
        for subscribers_list in self._get_subscribers_lists(channel):
            if properties is None:
                ...
                subscribers_list[:] = [
                    subscriber for subscriber in subscribers_list if subscriber.properties != properties]
...
if __name__ == '__main__':
    ...
    # Run this module and point your browser to http://localhost:5002
    ...
    def publish():
        ...
        full_message = template.format(html.escape(sender_username),
                                       html.escape(chat_message))
